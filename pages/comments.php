...
<div class="comments-inner clr">
	<div class="comments-title"> 
		<?php 
		if($comment_number == 0){
			echo esc_html__('be the first to comment on this article','hewo');
		}else {
			if($comment_number == 1){
				echo esc_html__('There is 1 comment for this article','hewo');
			}else if($comment_number > 1){
				echo sprintf(esc_html__('There are %s comments for this article','hewo'),$comment_number);
			}
		}
		?>
	</div>
	...
	<?php 
		$commentListArr = array('callback'=> 'alith_theme_comment');
